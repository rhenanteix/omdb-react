        ...
        return (
                    <div className="card">
                        ...
                        <div className="card-block">
                            ...
                            <p className="card-text">Lançamento: { this.props.data.Year }, Tipo: { this.props.data.Type }</p>
                            <div className="read-more">
                                <Link to={ `/detail/${this.props.data.imdbID}` } className='btn btn-primary'>Saiba Mais</Link>
                            </div>
                        </div>
                    </div>
        );
